...
class SurvivalGame:
    ...
    def init(self):
        ...
        while i<(self.n/2):
            ...
            #print isinstance(self.teleportObjects[i],self.teleportObjects[i].__class__)
    ...
    def gameStart(self):
        ...
        getClass=self.teleportObjects[0].__class__.__name__
        while(end!=True):
            end=True
            if turn==0:
                for obj in self.teleportObjects:
            ...
            for i in range(0,self.n):
                if(self.teleportObjects[i].health>0):
                    getClass=self.teleportObjects[i].__class__.__name__
                    break
            for i in range(0,self.n):
                if(self.teleportObjects[i].health>0):
                    if(self.teleportObjects[i].__class__.__name__!=getClass):
                        end=False
                        break
